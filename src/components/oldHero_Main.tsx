        ...
        <>
            <section className="bg-gradient-to-b md:bg-gradient-to-r from-secondary to-foreground">
                <div className="flex w-full responsive_box justify-center items-center h-auto relative">
                    ...
                    <div onClick={openGallery} className="md:w-1/2 border-t-2 flex-col-reverse md:flex-col md:border-t-0 border-devider container py-5 text-black flex md:items-end gap-5 relative group md:gifting 2xl:max-w-[600px]">
